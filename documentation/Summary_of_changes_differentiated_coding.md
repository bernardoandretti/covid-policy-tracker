...
- **Indicators**: 
 ...
 | --- | --- | ---|
  | `C1M`, `C2M`, `C3M`, `C4M`, `C5M`, `C6M`, `C7M`, `H6M`, `H8M` | Reports either E value if no differentiation, or the V or NV value if differentiated policies are in place, depending on which proportion of population are V or NV | Reports: <ul> <li>% people vaccinated, except for India and China subnational data  </li><li> ‘MV’ (Majority Vaccinated) for China and India subnational data  </li><li> ‘MNV’ (Majority Non-Vaccinated) for China and India subnational data </li> </ul> |
  |`C8EV` | Reports either E value if no differentiation, or the vaccinated value V | Reports: <ul> <li> % people vaccinated, except for India and China subnational data  </li><li> ‘MV’ (Majority Vaccinated) for China and India subnational data  </li><li> ‘MNV’ (Majority Non-Vaccinated) for China and India subnational data </li> </ul> |
...
- **Indices**:
 ...
 | --- | --- | ---| --- | ---|
  | Average | GRI_Average | CHI_Average | SI_Average | Reports: <ul> <li> Everyone value from indicators if no differentiation <br> - Weighted average if there are differentiated policies and good % vaccination data </li><li>  Simple average value if there is differentiation and no % vaccination data available. Note this only applies for India and China subnational data </li> </ul> |
